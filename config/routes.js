...
module.exports.routes = {
  ...
  'post /socketLogin' : 'PassportAuthController.loginProcessJSON',
  '/logout':     'PassportAuthController.logout',
  '/protected':  'PassportAuthController.protected',
  '/admin/users': 'PassportAuthController.adminUsers',
  '/admin/userlist': 'PassportAuthController.userList',
  '/admin/getStatus': 'PassportAuthController.getStatus',

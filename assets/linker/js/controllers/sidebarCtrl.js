    ...
    },
    {
    ...
    },
     {
        ...
        layers:[
          ...
          {name:'Thruway Radio Tower',selector:'thru_radio', loaded:false, visible:false, type:'d3',style:{cursor:'pointer',stroke:'black','stroke-width':'0px',fill:'blue'},mouseover:{info:[{name:"<strong>Site Name: ",prop:"SITE_NAME"},{name:"</strong>Category: ",prop:"TOWER_CATE"},{name:"Tower Owner: ",prop:"TOWER_OWNE"},{name:"Site Owner: ",prop:"SITE_OWNER"},{name:"Tower Height: ",prop:"TOWER_HEIG"}],style:{cursor:'pointer',stroke:'black', stroke:'red','stroke-width':'2px'}}},
          {name:'Thruway Microwave Lines',selector:'thru_micro', loaded:false, visible:false, type:'d3',style:{cursor:'pointer',stroke:'#CC14A3','stroke-width':'2px',fill:'purple'},mouseover:{info:[{name:"<strong>Name: ",prop:"Descriptio"}],style:{cursor:'pointer',stroke:'black', stroke:'red','stroke-width':'2px'}}},
